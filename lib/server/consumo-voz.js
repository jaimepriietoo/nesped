 ...
 *
 * Los dos lados han cambiado de sitio: quien pone la etiqueta es ahora
 * ElevenLabs, que marca cada línea de la transcripción con su papel, y quien
 * cuenta es persistElevenLabsCall al guardar la llamada. La constante sigue
 * siendo la misma y sigue habiendo un solo sitio donde se decide qué se
 * factura.
 */

/** Cómo se marca en la transcripción lo que dice el agente. */
export const ETIQUETA_AGENTE = "[AI] ";
 ...
 */
export function caracteresDelAgente(partes) {

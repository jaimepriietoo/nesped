...
const CLAVES = {
  growth: "nesped_growth",
  intelligence: "nesped_intelligence",
 ...
 */
/*
 * Ya no hay respaldo por variable de entorno.
 *
 * Lo había para cuando un plan aún no tenía etiqueta en Stripe, y fue justo
 * lo que hizo que la web anunciara un precio y Stripe cobrara otro: las
 * variables apuntaban a precios que se habían sustituido. Ahora los tres
 * planes tienen su etiqueta, así que la única fuente es Stripe.
 */
const RESPALDO_ENV = {};

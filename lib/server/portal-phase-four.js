    ...
    return [
      {
        ...
        trigger: "contacto estancado 10 días",
      ...
      },
      {
        ...
        body: "Correo premium + alta + paso a una persona.",
      },
    ];
  }
  ...
  return [
    {
      ...
      trigger: "contacto sin respuesta",
      body: "Secuencia WhatsApp + SMS + llamada con una única llamada a la acción.",
    },
    {
      id: "handoff-human",
      title: "Paso a una persona",
      trigger: "contacto con intención alta",
      body: "Asignar responsable, resumir objeciones y empujar cierre.",
    },
    {
      id: "expansion-play",
      title: "Expansión de valor",
      trigger: "cliente con ROI alto",
      body: "Propuesta de subida de plan o paquete superior con contexto.",
    },
  ];
}
...
export function buildWorkflowStudioData({
  ...
  const flows = [
    {
      ...
      trigger: "Contacto sin movimiento > 10 días",
    ...
    },
    {
      ...
      actions: ["Asignar responsable", "Sugerencia de la IA", "Contacto por voz", "Pago"],
    ...
    {
      id: "experiments",
      name: "Optimizador automático de guiones",
  ...
  const simulations = [
    {
      id: "close-hot",
      title: "Simular cierre de contacto caliente",
      outcome:
        hotLeads.length > 0
          ? `Hay ${hotLeads.length} contactos donde conviene probar una secuencia de cierre con una única llamada a la acción.`
          : "Ahora mismo faltan contactos calientes para esta simulación.",
    },
    {
      id: "recover-voice",
    ...
    {
      id: "owner-gap",
      title: "Simular reparto por responsable",
      outcome:
        missingOwner.length > 0
          ? `${missingOwner.length} contactos ganarían velocidad si entran por reparto automático.`
          : "La cobertura de responsable está bastante sana.",
    },
  ];
    ...
    reportBuilder: [
      {
        ...
        body: "Resumen corto de riesgo, embudo, control de calidad de voz e ingresos del día.",
      },
      {
        id: "weekly-revenue",
      ...
      },
      {
        ...
        body: "Control de calidad, objeciones repetidas y clasificación por responsable o agente.",
      },
    ],
  };
}
...
export function buildIntegrationsCenterData({
  ...
  const connectors = [
    ...
    },
    {
      ...
      detail: "Alertas operativas, pagos y contactos calientes.",
    },
    {
      id: "hubspot",
      name: "HubSpot",
      ...
      detail: "Sincronización de contactos, responsables y ciclo de vida.",
    },
    {
      id: "pipedrive",
      name: "Pipedrive",
      ...
      detail: "Embudo y actividad comercial bidireccional.",
    },
    {
      id: "zapier",
      name: "Zapier",
      ...
      detail: "Conectar Nesped con el conjunto de herramientas del cliente sin código.",
    },
    {
      id: "make",
      name: "Make",
      ...
      detail: "Escenarios sin código y automatizaciones externas.",
    },
    {
      id: "meta_ads",
      name: "Meta Ads",
  ...
  const identity = [
    {
      ...
      detail: "Acceso corporativo para clientes y equipos.",
    },
    {
      id: "sso_microsoft",
      name: "SSO Microsoft",
  ...
  return {
    ...
    recipes: [
      ...
      },
      {
        id: "ops-alerting",
        title: "Ops alerting",
        body: "Manda a Slack facturas fallidas, contactos críticos, fallos de voz y errores de flujos.",
      },
      {
        id: "partner-stack",
        title: "Herramientas de socios",
...
export function buildRevenueOsData({
  ...
  return {
    ...
    leakageMap: [
      {
        id: "stale",
        title: "Embudo estancado",
        value: stale.length,
        body: stale.length
          ? `${stale.length} contactos abiertos llevan demasiado tiempo sin moverse.`
          : "No hay atasco grave en el embudo.",
      },
      {
        id: "owner",
        ...
        body: noOwner.length
          ? `${noOwner.length} contactos pueden perderse por falta de accountability.`
          : "La cobertura de responsable está sana.",
      },
      {
        id: "billing",
    ...
    upgradeSignals: [
      {
        id: "roi",
        title: "Venta adicional inteligente",
        body:
          totalRevenue > 0
            ? `Con ${fmtMoney(totalRevenue)} ya trazados, tiene sentido empujar plan superior o add-ons.`
            : "Primero toca cerrar retorno visible antes de abrir subida de plan.",
      },
      {
        id: "trial",
        ...
        body:
          !activeSubscription
            ? "La cuenta está lista para el periodo de prueba, activación automática y configuración guiada."
            : "Ya existe suscripción activa; el foco pasa a expansión y retención.",
      },
      {
        id: "marketplace",
        title: "Tienda de guiones",
        body: `Con ${products.length || 0} productos y vertical ${client?.industry || "general"}, puedes vender paquetes o guiones por sector.`,
      },
    ],
    benchmark: {
      ...
      story:
        hotOpenLeads.length >= 8
          ...
          : "Todavía hay margen claro para subir captación, seguimiento o cierre frente a la referencia esperada.",
    },
    partnerProgram: [
      {
        id: "white-label",
        ...
        body: client?.custom_domain
          ? "La capa de marca blanca ya está encaminada para agencias y clientes grandes."
          : "Con el dominio y la imagen de marca cerrados, esta cuenta ya se podría revender como marca blanca.",
      },
      {
        id: "agencies",
        title: "Programa partner",
        body: "Prepara subcuentas, informes por cliente y paquetes de servicio para agencias.",
      },
    ],
  };
}

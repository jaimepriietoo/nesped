...
/* =========================================================================
   Stubs de los helpers derivados.

   El portal real calcula estas vistas con lib/portal-product.js. La demo no
   tiene módulos, así que devuelven directamente una versión de muestra con
   la misma forma que produce el helper.
   ========================================================================= */

/* Endpoints que la demo también debe responder. */
window.DEMO["/api/playbooks"] = {
  summary: { camposCubiertos: 6, ultimaEdicion: "hace 3 días" },
  workspace: {
    goal: "Conseguir una cita presencial o un presupuesto aceptado",
    tone: "Cercano, directo, sin tecnicismos",
    audience: "Particulares y comunidades que piden presupuesto",
    opening: "Buenas tardes, ha llamado a Nesped Demo. ¿En qué puedo ayudarle?",
    questions: "Qué necesita exactamente\nDónde está la vivienda\nSi ya tiene otros presupuestos\nCuándo le vendría bien",
    objections: "«Me lo tengo que pensar» → preguntar contra qué lo compara\n«Es caro» → desglosar plazo e instalación\n«Prefiero una persona» → ofrecer devolución de llamada",
    closing: "Le paso el presupuesto hoy y le llamamos mañana por la mañana.",
  },
  recommendations: [
    { id: "r1", title: "Falta preguntar el código postal", body: "Aparece en 9 llamadas revisadas." },
  ],
};

window.DEMO["/api/analytics/message-experiments"] = {
  summary: { variantes: 4, enviados: 212, respuestas: 63, mejorTasa: 41 },
  variants: [
    { id: "a", title: "Directa · «¿sigue interesado?»", value: 41, body: "86 envíos · 35 respuestas" },
    { id: "b", title: "Con precio en el primer mensaje", value: 28, body: "64 envíos · 18 respuestas" },
    { id: "c", title: "Solo cita, sin precio", value: 22, body: "41 envíos · 9 respuestas" },
    { id: "d", title: "Recordatorio seco", value: 5, body: "21 envíos · 1 respuesta" },
  ],
  suggestions: [
    { id: "s1", title: "Quedarse con la variante directa", body: "Gana por 13 puntos con muestra suficiente." },
  ],
};

window.DEMO["/api/analytics/revenue"] = { summary: { total: 18400, mes: 6200, media: 2140, operaciones: 12 } };
window.DEMO["/api/analytics/lead-revenue"] = { summary: { leadsConIngreso: 8, ticketMedio: 2140 },
  rows: [
    { id: "l1", title: "Marta Rubio", value: 4800, body: "Aerotermia" },
    { id: "l2", title: "Instalaciones Vega", value: 3200, body: "Placas solares" },
    { id: "l3", title: "Clínica Dental Sur", value: 1500, body: "Ortodoncia" },
  ] };
window.DEMO["/api/analytics/owner-revenue"] = { summary: { responsables: 3, mejor: "Jaime" },
  ranking: [
    { id: "o1", title: "Jaime", value: 9200, body: "5 cierres" },
    { id: "o2", title: "Laura", value: 6100, body: "3 cierres" },
    { id: "o3", title: "Sergio", value: 3100, body: "1 cierre" },
  ] };
window.DEMO["/api/analytics/voice-stats"] = { summary: { llamadas: 40, duracionMedia: 152, notaMedia: 79, capturaLeads: 62 } };
window.DEMO["/api/analytics/priority-stats"] = { summary: { alta: 5, media: 11, baja: 8 } };
window.DEMO["/api/analytics/reactivation-stats"] = { summary: { reactivados: 6, respondieron: 3, cerrados: 1 } };
window.DEMO["/api/analytics/appointment-stats"] = { summary: { citas: 9, confirmadas: 7, noAsistieron: 1 } };
window.DEMO["/api/analytics/upsells"] = { summary: { propuestas: 4, aceptadas: 1, ingresoExtra: 1800 } };

window.DEMO_HELPERS = {
  buildOnboardingWorkspace: () => ({
    readinessScore: 78,
    summary: { done: 7, pending: 2, integrations: 5 },
    checklist: [
      { id: "num", title: "Número de entrada asignado", done: true, body: "+34 983 460 825 apunta a la voz." },
      { id: "voz", title: "Agente de voz configurado", done: true, body: "Tono, apertura y preguntas definidos." },
      { id: "pagos", title: "Cobros conectados", done: true, body: "Stripe operativo con webhooks verificados." },
      { id: "correo", title: "Correo transaccional", done: true, body: "Resend verificado sobre tu dominio." },
      { id: "equipo", title: "Equipo dado de alta", done: true, body: "4 personas con acceso." },
      { id: "guion", title: "Guion comercial escrito", done: true, body: "Objetivo, tono y objeciones cubiertos." },
      { id: "obj", title: "Objetivos del mes fijados", done: true, body: "25 leads y 20 % de conversión." },
      { id: "dominio", title: "Dominio propio", done: false, body: "El portal se sirve todavía en nesped.com/portal." },
      { id: "saliente", title: "Llamada saliente", done: false, body: "Falta TELNYX_ACCOUNT_SID en Railway." },
    ],
    nextActions: [
      { id: "a1", title: "Añadir la credencial de Telnyx", body: "Sin ella el botón de demo de la web no llama." },
      { id: "a2", title: "Apuntar el CNAME del dominio", body: "Portal en tu propia marca en menos de una hora." },
    ],
    integrations: [
      { id: "i1", title: "Telnyx", body: "Telefonía", status: "warning" },
      { id: "i2", title: "ElevenLabs", body: "Voz", status: "ready" },
      { id: "i3", title: "Stripe", body: "Cobros", status: "ready" },
      { id: "i4", title: "Resend", body: "Correo", status: "ready" },
      { id: "i5", title: "Supabase", body: "Datos", status: "ready" },
      { id: "i6", title: "Sentry", body: "Errores", status: "ready" },
    ],
  }),
  ...
  buildDerivedNotifications: () => ({
    ...
    threads: [
      { id: "n1", category: "pipeline", severity: "high", title: "3 leads calientes llevan más de 48 h sin contactar", body: "Marta Rubio, Instalaciones Vega y Clínica Dental Sur.", created_at: new Date(Date.now() - 3 * 3600e3).toISOString() },
      { id: "n2", category: "sistema", severity: "high", title: "La llamada saliente no está operativa", body: "Falta TELNYX_ACCOUNT_SID en el servidor de voz.", created_at: new Date(Date.now() - 8 * 3600e3).toISOString() },
      { id: "n3", category: "voz", severity: "medium", title: "Una de cada cuatro llamadas se corta antes de 40 s", body: "Casi todas entre las 14:00 y las 16:00.", created_at: new Date(Date.now() - 26 * 3600e3).toISOString() },
      { id: "n4", category: "equipo", severity: "medium", title: "Cuatro leads siguen sin responsable", body: "Sin dueño tardan 3,2 días más en cerrarse.", created_at: new Date(Date.now() - 30 * 3600e3).toISOString() },
      { id: "n5", category: "cuenta", severity: "low", title: "Marina Ortiz lleva 12 días inactiva pero conserva acceso", body: "Conviene revisar los accesos.", created_at: new Date(Date.now() - 50 * 3600e3).toISOString() },
    ],
  }),

  buildRoiSnapshot: () => ({
    summary: { totalRevenue: 18400, costeMensual: 1490, retorno: 1234, mesesAmortizacion: 1 },
    story: "Por cada euro invertido, la cuenta ha devuelto 12,3. El grueso viene de llamadas fuera de horario que antes se perdían.",
    focusAreas: [
      { id: "f1", title: "Fuera de horario", value: 7200, body: "Ingresos de llamadas que antes nadie cogía." },
      { id: "f2", title: "Segundo intento", value: 4100, body: "De leads que no cogieron a la primera." },
      { id: "f3", title: "Reactivación de fríos", value: 2600, body: "De contactos parados más de 14 días." },
    ],
  }),

  buildControlTowerSnapshot: () => ({
    summary: { alertasAbiertas: 5, flujosActivos: 3, serviciosListos: 5, notaVoz: 79 },
    workflows: [
      { id: "w1", title: "Devolución fuera de horario", body: "4 ejecuciones hoy", status: "active" },
      { id: "w2", title: "Segundo intento", body: "11 ejecuciones hoy", status: "active" },
      { id: "w3", title: "Sin respuesta 7 días", body: "En pausa", status: "paused" },
    ],
    feed: [
      { id: "e1", title: "Lead capturado", body: "Marta Rubio · aerotermia", created_at: new Date(Date.now() - 3600e3).toISOString() },
      { id: "e2", title: "Llamada transcrita", body: "3 min 12 s · nota 84", created_at: new Date(Date.now() - 2 * 3600e3).toISOString() },
      { id: "e3", title: "SMS enviado", body: "Presupuesto a Instalaciones Vega", created_at: new Date(Date.now() - 5 * 3600e3).toISOString() },
    ],
    watchlist: [
      { id: "v1", title: "Franja de 14:00 a 16:00", body: "Cortes por encima de lo normal.", level: "warning" },
      { id: "v2", title: "Llamada saliente", body: "Credencial ausente.", level: "critical" },
    ],
  }),
  ...
  buildMessageExperimentSummary: () => ({
    ...
    suggestions: [
      { id: "s1", title: "Quedarse con la variante directa", body: "Gana por 13 puntos con muestra suficiente." },
      { id: "s2", title: "Retirar el recordatorio seco", body: "Un 5 % de respuesta no justifica el envío." },
    ],
  }),
};

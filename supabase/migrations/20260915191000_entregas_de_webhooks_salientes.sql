-- Entregas de webhooks salientes.
--
-- Lo que Nesped le manda a los sistemas del cliente (clients.webhook), una
-- fila por entrega: evento, URL, cuerpo, estado, intentos, qué contestó el
-- destino y el último error. La cola las manda firmadas con reintentos
-- (lib/server/webhooks-salientes.js); el portal las enseña y permite
-- reintentar. Se purgan a los treinta días.

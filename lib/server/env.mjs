const FEATURE_DEFINITIONS = [
  {
    ...
    checks: [
      ...
      {
        label: "Portal RLS mode",
        names: ["NESPED_RLS_PORTAL"],
        level: "recommended",
      },
      {
        label: "Supabase publishable key for portal RLS",
      ...
      {
        label: "Supabase JWT secret for portal RLS",
      ...
      {
        label: "Dedicated TOTP encryption key",
      ...
      {
        label: "Dedicated audit checkpoint signing secret",

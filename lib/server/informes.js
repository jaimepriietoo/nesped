...
export async function enviarInforme({ tipo, clientId, paraSiNoHay = null }) {
  ...
  if (errorCliente) throw new Error(errorCliente.message || "No se encontró la empresa");
  ...
  if (!destino) {
    ...
    throw new Error("La empresa no tiene correo de contacto y no se indicó otro");
  }

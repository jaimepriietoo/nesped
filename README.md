...
> empresa `fibergreen` desde el 18 de septiembre de 2026. Cómo
...
| [`docs/rls-por-empresa.md`](docs/rls-por-empresa.md) | despliegue por fases, variables, prueba cruzada y rollback del rol de mínimo privilegio |

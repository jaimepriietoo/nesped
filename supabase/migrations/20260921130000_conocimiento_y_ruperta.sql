-- Lo que la IA tiene que saber ahora, y quién puede decírselo por teléfono.
--
-- `conocimiento`: avisos y datos que la empresa escribe en el portal (o dicta
-- por teléfono en modo Ruperta) y que la IA tiene en cuenta al atender y al
-- escribir: "el pueblo de Valdestillas está sin servicio hasta las 18h".
-- Cada uno puede caducar solo.
--
-- `client_settings.ruperta_pin_hash`: el PIN que hay que decir por teléfono,
-- además de llamar desde el número de un owner/admin, para que la IA acepte
-- instrucciones. Nunca en claro: scrypt, como las contraseñas.

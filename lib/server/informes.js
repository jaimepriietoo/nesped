...
export async function enviarInforme({ tipo, clientId, paraSiNoHay = null }) {
  ...
  /* Nadie espera un informe delante de la pantalla: lo pidió hace un rato y
     lo recibirá cuando llegue. Si Resend está caído, mejor esperar a que
     vuelva que gastar cinco reintentos contra una pared. */
  await enviarCorreo({
    quienEspera: "nadie",
    to: destino,

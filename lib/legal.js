...
export const ENCARGADOS = [
  { nombre: "Supabase", para: "Base de datos, grabaciones propias y almacenamiento", donde: "Unión Europea (Irlanda)", fuera: false },
  { nombre: "Vercel", para: "Alojamiento de la web, del portal y de la API", donde: "Unión Europea (Irlanda) para la ejecución; gestión en Estados Unidos", fuera: true },
  { nombre: "Twilio", para: "Línea telefónica: recibir y cursar las llamadas y, si se activa, WhatsApp y SMS", donde: "Estados Unidos e Irlanda", fuera: true },
  { nombre: "ElevenLabs", para: "El asistente de voz que atiende la llamada: reconocimiento de voz, conversación, síntesis de voz, grabación y transcripción", donde: "Estados Unidos", fuera: true },
  { nombre: "Google (Gemini), a través de ElevenLabs", para: "Modelo de lenguaje con el que el asistente decide qué contestar", donde: "Estados Unidos", fuera: true },
  { nombre: "OpenAI", para: "Clasificación de contactos, respuestas sugeridas y copiloto del portal (texto, no voz)", donde: "Estados Unidos", fuera: true },
  { nombre: "Railway", para: "Proceso de fondo que mantiene la cola de trabajos; no trata llamadas", donde: "Estados Unidos", fuera: true },
  { nombre: "Stripe", para: "Cobro de suscripciones", donde: "Estados Unidos e Irlanda", fuera: true },
  { nombre: "Resend", para: "Correo transaccional, códigos de acceso y avisos a los departamentos del cliente", donde: "Estados Unidos", fuera: true },

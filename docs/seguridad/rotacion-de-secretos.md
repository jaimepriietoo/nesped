...
| `CRON_SECRET` | `openssl rand -hex 32`; el mismo valor en Supabase Vault (`nesped_cola_cron_secret`), pegado desde el panel. Sólo abre `/api/cola/procesar` | No: Vercel Cron lo manda tal cual está guardado | [ ] |

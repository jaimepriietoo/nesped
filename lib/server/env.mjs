const FEATURE_DEFINITIONS = [
  ...
  },
  {
    ...
    checks: [
      {
        label: "Public voice base URL",
        names: ["BASE_URL"],
        level: "required",
      },
      {
        label: "Telnyx API key",
        names: ["TELNYX_API_KEY"],
        level: "recommended",
      },
      {
        label: "Telnyx account SID",
        names: ["TELNYX_ACCOUNT_SID"],
        level: "recommended",
      },
      {
        label: "Telnyx TeXML application id",
        names: ["TELNYX_TEXML_APPLICATION_ID", "TELNYX_APPLICATION_SID"],
        level: "recommended",
      },
      {
        label: "Telnyx outbound number",
        names: ["TELNYX_PHONE_NUMBER"],
        level: "recommended",
      },
      {
        label: "Telnyx webhook secret",
        names: ["TELNYX_WEBHOOK_SECRET"],
        level: "recommended",
      },
      {
    ...
    checks: [
      {
        ...
        names: ["TELNYX_PUBLIC_KEY"],
        level: "recommended",
      },
      {
        label: "Telnyx SMS number",
        names: ["TELNYX_SMS_NUMBER", "TELNYX_PHONE_NUMBER"],
        level: "recommended",
      },
      {
        label: "Telnyx WhatsApp number",
        names: ["TELNYX_WHATSAPP_NUMBER", "TELNYX_PHONE_NUMBER"],
        level: "recommended",
      },
      {
  ...
  },
  {
    ...
    checks: [
      {
        label: "Server Sentry DSN",
        names: ["SENTRY_DSN", "NEXT_PUBLIC_SENTRY_DSN"],
        level: "recommended",
      },
      {
        label: "Browser Sentry DSN",
